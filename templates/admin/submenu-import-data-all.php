							...
							<table class="form-table">
								<tbody>
									...
									<tr>
										<th scope="row">
											<label for="" class="form-label">
												<?php _e('Arquivos Indicadores', OBS_TEXT_DOMAIN) ?>
											</label>
										</th>
										<td>
											<input type="file" class="form-control" id="obs-file-indicadores" multiple>
										</td>
									</tr>
									<tr>
										<td colspan="2" class="text-center">
											<button type="button" class="btn btn-primary btn-upload-xls-all">
